...
public class StyleFilterAdapter extends RecyclerView.Adapter<StyleFilterAdapter.RecyclerViewHolder> {
    private Context mContext;
    List<Category> filterList;

    public StyleFilterAdapter(Context mContext, List<Category> filterList, String selectedfilter) {
