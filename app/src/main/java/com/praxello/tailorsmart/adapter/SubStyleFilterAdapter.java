...
public class SubStyleFilterAdapter extends RecyclerView.Adapter<SubStyleFilterAdapter.RecyclerViewHolder> {
    private Context mContext;
    List<Category> filterList;

    public SubStyleFilterAdapter(Context mContext, List<Category> filterList, String selectedfilter) {
    ...
    public List<Category> getSubStyleFilterList() {
        return filterList;
    }
