...
import com.praxello.tailorsmart.adapter.AppointmentFabricAdapter;
...
public class AppointmentFabricListActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (selectedItem != null && selectedItem.getFabrics() != null && selectedItem.getFabrics().size() > 0) {
            toolbarTitle.setText("Fabrics(" + selectedItem.getFabrics().size() + ")");
            recyclerView.setAdapter(new AppointmentFabricAdapter(mContext, selectedItem.getFabrics()));
